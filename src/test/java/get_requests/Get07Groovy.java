...
public class Get07Groovy extends JsonPlaceHolderBaseUrl {
    /*
      Given
    ...
    public void get07() {
        ...
        //List<Object> list = jsonPath.getList("");//Bu bana listin tamamini verir
        //List<Integer> list1 = jsonPath.getList("id");//Bu bana listedeki id leri verir. id'ler ise Integer oldugu icin List<Integer> kullandik
        List<Integer> list = jsonPath.getList("findAll{it.id>190}.id");
        //Groovy Language --> Java temelli programlama dili
        //Groovy Language kullanabilmem icin gelen response list olmali
        //jsonPath.getList() list verdigi icin bunu "findAll{it.id>190}.id" yazdim. Mesela icerideki bir degisken verseydi mesela name
        //name.findAll{it.id>190}.id yazmali idim
